 ...
 * @author hp
 */
public class avgpricechart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
                ...
                crs.setCommand("select avg(price),locationname from photos,locations where photos.LOCATIONID = locations.LOCATIONID group by locationname");
                crs.execute();
                StringBuilder r = new StringBuilder("[ [\"Location\", \"Price\"],");
                while(crs.next()){
